...
export default tseslint.config(
  ...
  // (vendor/ + tools/ were removed when the Python parity oracle was retired — their ignore entries went with them.)
  { ignores: ["dist/**", "node_modules/**", "coverage/**", "test/fixtures/magika_corpus/**"] },
