...
// The frozen Python clone step is called by the refresh workflow as THREE string positionals —
// `workflow.execute_activity("clone_repository_activity", args=[str(installation_id),
// str(repository_id), head_sha])` (vendor/codemaster-py/codemaster/workflows/
// refresh_semantic_docs_workflow.py:72-81). The TS port collapses those three positionals into ONE
...
// NO frozen Python Pydantic model with THIS field shape (the Python `CloneRequestV1` in
