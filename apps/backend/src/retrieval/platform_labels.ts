// platform_labels (Sub-spec B T17) — the full set of labels the platform exposes to repo-level `.codemaster.yaml` configurations + the
...
//
// Single source-of-truth, assembled from:
