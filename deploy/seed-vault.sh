...
vault kv put "${MOUNT}/codemaster/confluence/token" base_url='<BASE_URL>' token='<TOKEN>'

# codemaster/api/auth (optional) — session signing key (auth routes) — auto-generated + persisted if unset
